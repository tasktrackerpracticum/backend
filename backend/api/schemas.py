...
organization_id_in_query = openapi.Parameter(
    'organization_id', openapi.IN_QUERY, type=openapi.TYPE_INTEGER)
task_id_in_query = openapi.Parameter(
    'task_id', openapi.IN_QUERY, type=openapi.TYPE_INTEGER, required=True)
